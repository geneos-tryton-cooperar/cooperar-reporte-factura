...
class MyInvoiceReport(Report):
    ...
    def crear_reporte(cls, invoice):
        ...
        if invoice.invoice_type.id == 1: #Factura A
            ...
            return out.read()
        elif invoice.invoice_type.id == 2:  #Factura B
